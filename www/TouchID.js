...
TouchID.prototype.saveToKeychain = function(password, successCallback, errorCallback) {
  cordova.exec(successCallback, errorCallback, "TouchID", "saveToKeychain", [password]);
};
